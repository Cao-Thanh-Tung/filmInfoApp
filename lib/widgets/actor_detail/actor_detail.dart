...
import 'package:my_first_flutter_app/widgets/media_list/media_list_item.dart';
import 'package:my_first_flutter_app/widgets/utilviews/fitted_circle_avatar.dart';
        ...
        return snapshot.hasData
            ? ListView.builder(
                itemBuilder: (BuildContext context, int index) =>
                    MediaListItem(snapshot.data!.elementAt(index)), //bug
