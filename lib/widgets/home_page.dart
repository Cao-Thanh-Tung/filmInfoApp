...
import 'package:my_first_flutter_app/widgets/media_list/media_list.dart';
import 'package:my_first_flutter_app/widgets/utilviews/toggle_theme_widget.dart';
...
class HomePageState extends State<HomePage> {
  ...
  List<BottomNavigationBarItem> _getNavBarItems() {
    if (mediaType == MediaType.movie) {
      return [
        BottomNavigationBarItem(icon: Icon(Icons.thumb_up), label: 'Popular'),
      ...
      return [
        BottomNavigationBarItem(icon: Icon(Icons.thumb_up), label: 'Popular'),
        BottomNavigationBarItem(icon: Icon(Icons.live_tv), label: 'On The Air'),
        BottomNavigationBarItem(icon: Icon(Icons.star), label: 'Top Rated'),
      ];
    }
  }
